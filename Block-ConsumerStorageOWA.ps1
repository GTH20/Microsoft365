...
#
.SYNOPSIS
Description: This script will block the ability for users to connect to Consumer cloud storage locations via OWA.

Prerequisites: The tenant will require any Exchange Online plan, and Connect to Exchange Online via PowerShell using MFA:
...
.NOTES
    FileName:    Block-ConsumerStorageOWA.ps1
