...
#
.SYNOPSIS
Description: This script configures auditing for Exchange Online.

Prerequisites: The tenant will need any Exchange Online plan, and Connect to Exchange Online via PowerShell using MFA:
...
.NOTES
    FileName:    Configure-Auditing.ps1
