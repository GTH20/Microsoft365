...
.SYNOPSIS
    ...
    2. You must have the ExchangeOnline PowerShell module installed in order to use this script, i.e. Install-Module ExchangeOnlineManagement.
    3. Make sure to run Connect-IPPSSession either before or while executing Install-Module ExchangeOnlineManagement.
...
if (!$AlertingEmail) {
$AlertingEmail = Read-Host "Enter the email address at which you will receive alerts."
Write-Host
}
